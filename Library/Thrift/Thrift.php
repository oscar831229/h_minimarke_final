...
if(!isset($GLOBALS['THRIFT_ROOT'])){
	$GLOBALS['THRIFT_ROOT'] = 'Library/Thrift';
}
require_once $GLOBALS['THRIFT_ROOT'].'/packages/cassandra/Cassandra.php';
require_once $GLOBALS['THRIFT_ROOT'].'/packages/cassandra/cassandra_types.php';
require $GLOBALS['THRIFT_ROOT'].'/protocol/TProtocol.php';
require $GLOBALS['THRIFT_ROOT'].'/transport/TTransport.php';
require $GLOBALS['THRIFT_ROOT'].'/transport/TSocket.php';
require $GLOBALS['THRIFT_ROOT'].'/protocol/TBinaryProtocol.php';
require $GLOBALS['THRIFT_ROOT'].'/transport/TFramedTransport.php';
