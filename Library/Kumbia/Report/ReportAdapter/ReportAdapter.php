...
class ReportAdapter extends Object {
	...
	/**
	 * Agrega espacios de firma
	 *
	 * @param array $fields('title1', 'title2', ...)
	 * @param int $breakLines
	 */
	public function addSignature($fields=array(), $breakLines=1)
	{
		return $this->_addSignature($fields, $breakLines);
	}
	 ...
	 */
	public function outputToFile($fileName, $addRand=true)
	{
		if($addRand==true){
