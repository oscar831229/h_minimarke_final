...
//	implements DbBaseInterface
	 ...
	 */
	public function __construct($descriptor='', $persistent=false)
	{
		if($descriptor==''){
			$descriptor = $this->_descriptor;
		}
		$this->connect($descriptor, $persistent);
	}
	...
	/**
	 * Obtiene la información del servidor MySQL
	 *
	 */
