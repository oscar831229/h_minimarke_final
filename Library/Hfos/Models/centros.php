...
class Centros extends RcsRecord {
	...
	public function initialize(){
		$this->hasMany('centro_costo', 'Movi', 'codigo');
		$this->hasMany('centro_costo', 'Activos', 'codigo');
		$this->hasMany('centro_costo', 'Pres', 'codigo');
		$this->hasMany('centro_costo', 'Movihead', 'codigo');
	}
