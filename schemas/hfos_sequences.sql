...
--
-- Host: localhost    Database: hfos_sequences
-- ------------------------------------------------------
...
CREATE TABLE `consecutivo` (
  `prefijo` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `consecutivo` VALUES ('RC',0);
...
-- Dump completed on 2012-01-28 15:21:53
