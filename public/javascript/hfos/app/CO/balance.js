 ...
 */
var Balance = Class.create(HfosProcessContainer, {
...
HfosBindings.late('win-balance', 'afterCreateOrRestore', function(hfosWindow){
	var balance = new Balance(hfosWindow);
});
