 ...
 */
var ListadoRetencion = Class.create(HfosProcessContainer, {
	...
	initialize: function(container){
		...
		new HfosForm(this, 'listadoRetencionForm', {
			update: 'resultados',
...
HfosBindings.late('win-listado-retencion', 'afterCreateOrRestore', function(hfosWindow){
	var listadoRetencion = new ListadoRetencion(hfosWindow);
});
