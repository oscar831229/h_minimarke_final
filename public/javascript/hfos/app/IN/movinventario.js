 ...
 */
var movInventario = Class.create(HfosProcessContainer, {
	...
	initialize: function(container){
		...
		new HfosForm(this, 'movinventarioForm', {
			update: 'resultados',
...
HfosBindings.late('win-movinventario', 'afterCreateOrRestore', function(hfosWindow){
	var movinventario = new movInventario(hfosWindow);
});
