...
var Validator = Class.create({
	...
	_validate: {
		...
		blankStrings: ['@'], //Matriz con todos los strings que serán considerados como nulos
		...
		value: null, //Valor que debe ser espec�fico para un campo
...
* Opcionalmente se pueden incluir un parametro m�s, que se refiere al inicio desde el cual se va a empezar a evaluar los parametros, por
* defecto este valor est� en 1
*
*/
...
* Parametros:
* id = identificaci�n que va a ser usada en el nombre del div que contiene el mensaje
* msg = mensaje que se va a desplegar
* tipo = clase de mensaje que se va a mostrar (error, warning)
* Opcionalmente se pueden incluir varios parametros m�s, uno de ellos tiene que ver con la ubicacion del mensaje
* por obligaci�n se necesita una posici�n en pantalla que de un top o un left, un elemento que nos de la
* ubicacion del para que el mensaje se posicione de manera relativa o una combinaci�n de los dos.
*
*/
