...
function xls($result, $sumArray, $title, $weightArray, $headerArray)
{
	...
	$titulo_verdana  = $workbook->addFormat(array(
		'fontfamily' => 'Verdana',
		'size' => 20
	));
	$titulo_verdana2 = $workbook->addFormat(array(
		'fontfamily' => 'Verdana',
		'size' => 18
	));
	...
	$column_title = $workbook->addFormat(array(
		'fontfamily' => 'Verdana',
		'size' => 12,
		'fgcolor' => 12,
		'border' => 1,
	...
	$column = $workbook->addFormat(array(
		'fontfamily' => 'Verdana',
		'size' => 11,
		'border' => 1,
		'bordercolor' => 'black',
	...
	$column_centered = $workbook->addFormat(array(
		'fontfamily' => 'Verdana',
		'size' => 11,
		'border' => 1,
		'bordercolor' => 'black',
	...
	if (isset($raw_output)) {
		...
		StandardGenerator::formsPrint("<script type='text/javascript'> window.open('".Core::getInstancePath()."temp/".$file.".xls', null);  </script>");
	}
