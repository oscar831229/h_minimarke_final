 ...
 * @package 	Report
 * @subpackage 	Adapters
 * @copyright	Copyright (c) 2008-2013 Louder Technology COL. (http://www.loudertechnology.com)
...
class ExcelReport extends ReportAdapter implements ReportInterface
{
	...
	protected function _finish()
	{
		...
		$this->_prepareFooter();
		//Arreglo temporal
		$this->_excel->getActiveSheet()->setCellValue('A1', '1');
	}
