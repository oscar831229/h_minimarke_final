...
class Amortizacion extends ActiveRecord {
	...
	/**
	 * Metodo para establecer el valor del campo diferidos_id
	 * @param integer $diferidos_id
	 */
	public function setDiferidosId($diferidos_id){
		$this->diferidos_id = $diferidos_id;
	}
	...
	/**
	 * Devuelve el valor del campo diferidos_id
	 * @return integer
	 */
	public function getDiferidosId(){
		return $this->diferidos_id;
	}
