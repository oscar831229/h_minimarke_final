 ...
 * @access 		public
 */
class FluxViewResponse
#implements ViewResponseInterface
{
	...
	/**
	 * Genera la presentacion serializada
	 *
	 * @param ControllerResponse $controllerResponse
	...
	public function render($controllerResponse, $valueReturned){
		...
		echo serialize($valueReturned);
	}

	/**
	 * Administra las excepciones serializadas
	 *
	 * @param	ControllerResponse $controllerResponse
	 * @param	Exception $e
	 */
