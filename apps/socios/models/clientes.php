...
class Clientes extends ActiveRecord {
	...
	/**
	 * Metodo para establecer el valor del campo tipcre
	 * @param string $tipcre
	 */
	public function setTipcre($tipcre){
		$this->tipcre = $tipcre;
	}
	...
	/**
	 * Metodo para establecer el valor del campo soundphone
	 * @param string $soundphone
	 */
	public function setSoundphone($soundphone){
	...
	/**
	 * Devuelve el valor del campo tipcre
	 * @return string
	 */
	public function getTipcre(){
		return $this->tipcre;
	}
	...
	/**
	 * Devuelve el valor del campo soundphone
	 * @return string
	 */
	public function getSoundphone(){
		return $this->soundphone;
	}
