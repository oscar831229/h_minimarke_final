...
class ProyeccionController extends ApplicationController {
	...
	public function generarAction(){
		...
		try {
			...
			$cuotaInicial = 0;//por defecto 0
			$valorTotal = $saldoPagar = $this->getPostParam('saldoPagar', 'double');
			if(!$saldoPagar){
			...
			$interesUsura2 = $sociosFactura->getTasaDeMora($fechaPrimeraCuota,$transaction);
