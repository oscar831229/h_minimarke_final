...
class Comprob extends RcsRecord {
	...
	public function beforeDelete(){
		...
		if($this->countCuentasBancos()){
			$this->appendMessage(new ActiveRecordMessage('No se puede eliminar el comprobante porque está asociado a cuentas bancarias', 'codigo'));
			return false;
		}
	}
	...
	public function initialize(){
		...
		$this->hasMany('comprob', 'CuentasBancos', 'codigo');
