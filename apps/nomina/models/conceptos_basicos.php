...
class ConceptosBasicos extends ActiveRecord {
	...
	protected function beforeSave(){
		if($this->estado=='A'){
			...
			if($this->retencion=='S'){
				if(!$this->porc_retencion){
					$this->appendMessage(new ActiveRecordMessage('El concepto causa retención pero no se indicó el porcentaje de retención', 'porc_retencion'));
					return false;
				}
			}
		}
