...
class MoviMigration_100 extends ActiveRecordMigration {

	public function up(){
		$this->morphTable('movi', array(
			'columns' => array(
			...
			'indexes' => array(
				...
				new DbIndex('l_movi1', array(
					'cuenta',
					'fecha'
				)),
				new DbIndex('l_movi2', array(
					'cuenta',
					'nit',
					'fecha'
				)),
				new DbIndex('l_movi', array(
					'comprob',
					'numero',
					'fecha'
				))
