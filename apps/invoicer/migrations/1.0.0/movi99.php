...
class Movi99Migration_100 extends ActiveRecordMigration {

	public function up(){
		$this->morphTable('movi99', array(
			'columns' => array(
			...
			'indexes' => array(
				new DbIndex('l_movi99', array(
					'comprob',
					'numero'
				)),
				new DbIndex('l_movi991', array(
					'cuenta',
					'fecha'
				)),
				new DbIndex('l_movi992', array(
					'cuenta',
					'nit',
					'fecha'
				)),
				new DbIndex('l_movi993', array(
					'cuenta',
					'centro_costo',
					'fecha'
				))
