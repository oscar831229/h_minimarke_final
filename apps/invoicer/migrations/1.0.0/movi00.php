...
class Movi00Migration_100 extends ActiveRecordMigration {

	public function up(){
		$this->morphTable('movi00', array(
			'columns' => array(
			...
			'indexes' => array(
				new DbIndex('l_movi00', array(
					'comprob',
					'numero'
				)),
				new DbIndex('l_movi001', array(
					'cuenta',
					'fecha'
				)),
				new DbIndex('l_movi002', array(
					'cuenta',
					'nit',
					'fecha'
				)),
				new DbIndex('l_movi003', array(
					'cuenta',
					'centro_costo',
					'fecha'
				))
