...
class Habitacion extends ActiveRecord {
	...
	/**
	 * Metodo para establecer el valor del campo signature
	...
	/**
	 * Devuelve el valor del campo signature
	 * @return string
	 */
	...
	public function initialize(){
		$this->belongsTo('codest', 'Esthab', 'codest');
		$this->belongsTo('codcla', 'Clahab', 'codcla');
	}
