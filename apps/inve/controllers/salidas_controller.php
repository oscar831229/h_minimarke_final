 ...
 * SalidasController
 *
 * Controlador de las salidas al almacén
 *
 */
class SalidasController extends HyperFormController
{

	static protected $_config = array(
		'model' => 'Movihead',
		'plural' => 'salidas del almacén',
		'single' => 'salida del almacén',
		'genre' => 'F',
		'tabName' => 'Salida',
	...
	public function saveAction()
	{
		...
		return array(
			...
			'message' => 'Se grabó la salida del almacén con el número: "'.$numeros['inve'].'"',
			'type' => 'insert',
	...
	public function deleteAction()
	{
		...
		$movement['Comprobante'] = sprintf("C%02s", $movement['Almacen']);
		...
		return array(
			'status' => 'OK',
			'message' => 'La salida fue eliminada correctamente'
		);
	}
