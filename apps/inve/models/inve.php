...
class Inve extends RcsRecord
{
	...
	/**
	 * Metodo para establecer el valor del campo unidad_porcion
	 * @param string $unidad_porcion
	 */
	public function setUnidadPorcion($unidad_porcion){
		$this->unidad_porcion = $unidad_porcion;
	}
	 ...
	 * @param integer $plazo_reposicion
	 */
	...
	/**
	 * Metodo para establecer el valor del campo iva_venta
	 * @param integer $iva_venta
	 */
	public function setIvaVenta($iva_venta){
	...
	/**
	 * Metodo para establecer el valor del campo prod_trib
	 * @param string $prod_trib
	 */
	public function setProdTrib($prod_trib){
		$this->prod_trib = $prod_trib;
	}
	...
	/**
	 * Devuelve el valor del campo unidad_porcion
	 * @return string
	 */
	...
	/**
	 * Devuelve el valor del campo iva_venta
	 * @return integer
	 */
	...
	/**
	 * Devuelve el valor del campo prod_trib
	 * @return string
	 */
	public function getProdTrib(){
		return $this->prod_trib;
	}

	protected function beforeCreate(){
		$this->item = strtoupper($this->item);
	}
