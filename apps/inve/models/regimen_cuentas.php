...
class RegimenCuentas extends ActiveRecord {
	...
	/**
	 * Metodo para establecer el valor del campo cta_iva5d
	 * @param string $cta_iva5d
	 */
	public function setCtaIva5d($cta_iva5d){
		$this->cta_iva5d = $cta_iva5d;
	}

	/**
	 * Metodo para establecer el valor del campo cta_iva5r
	 * @param string $cta_iva5r
	 */
	public function setCtaIva5r($cta_iva5r){
		$this->cta_iva5r = $cta_iva5r;
	}
	...
	/**
	 * Devuelve el valor del campo cta_iva5d
	 * @return string
	 */
	public function getCtaIva5d(){
		return $this->cta_iva5d;
	}

	/**
	 * Devuelve el valor del campo cta_iva5r
	 * @return string
	 */
	public function getCtaIva5r(){
		return $this->cta_iva5r;
	}
