...
class Dathot extends ActiveRecord {
	...
	/**
	 * Metodo para establecer el valor del campo notsoft
	 * @param string $notsoft
	 */
	public function setNotsoft($notsoft){
		$this->notsoft = $notsoft;
	}
	...
	/**
	 * Metodo para establecer el valor del campo whemet
	 * @param string $whemet
	 */
	public function setWhemet($whemet){
		$this->whemet = $whemet;
	}
	...
	/**
	 * Devuelve el valor del campo notsoft
	 * @return string
	 */
	public function getNotsoft(){
		return $this->notsoft;
	}
	...
	/**
	 * Devuelve el valor del campo whemet
	 * @return string
	 */
	public function getWhemet(){
		return $this->whemet;
	}
