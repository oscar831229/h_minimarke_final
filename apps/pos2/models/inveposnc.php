...
class Inveposnc extends ActiveRecord {
	...
	/**
	 * Metodo para establecer el valor del campo nota_credito_id
	 * @param integer $nota_credito_id
	 */
	public function setNotaCreditoId($nota_credito_id){
		$this->nota_credito_id = $nota_credito_id;
	}
	
	/**
	 * Metodo para establecer el valor del campo invepos_id
	 * @param integer $invepos_id
	 */
	public function setInveposId($invepos_id){
		$this->invepos_id = $invepos_id;
	}
	...
	/**
	 * Devuelve el campo nota_credito_id
	 * @return integer
	 */
	...
	/**
	 * Devuelve el campo invepos_id
	 * @return integer
	 */
	public function getInveposId(){
		return $this->invepos_id;
	}
