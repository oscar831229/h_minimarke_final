...
class Movibackupniif extends ActiveRecord {
	...
	/**
	 * Metodo para establecer el valor del campo deleted_time
	 * @param Date $deleted_time
	 */
	...
	/**
	 * Devuelve el valor del campo deleted_time
	 * @return Date
	 */
	public function getDeletedTime(){
		if($this->deleted_time){
			return new Date($this->deleted_time);
		} else {
			return null;
		}
	}
