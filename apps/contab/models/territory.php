...
class Territory extends ActiveRecord {
	...
	/**
	 * Metodo para establecer el valor del campo language
	...
	/**
	 * Metodo para establecer el valor del campo prefered_locale
	 * @param string $prefered_locale
	 */
	public function setPreferedLocale($prefered_locale){
		$this->prefered_locale = $prefered_locale;
	}
	...
	/**
	 * Devuelve el valor del campo language
	 * @return string
	 */
	...
	/**
	 * Devuelve el valor del campo prefered_locale
	 * @return string
	 */
	public function getPreferedLocale(){
		return $this->prefered_locale;
	}
