...
class MoviNiif extends ActiveRecord {
	...
	/**
	 * Metodo para establecer el valor del campo cuenta_movi
	 * @param string $cuenta_movi
	 */
	public function setCuentaMovi($cuenta_movi){
		$this->cuenta_movi = $cuenta_movi;
	}

	/**
	 * Metodo para establecer el valor del campo nic
	 * @param integer $nic
	 */
	...
	/**
	 * Metodo para establecer el valor del campo nota_nic
	 * @param string $nota_nic
	 */
	public function setNotaNic($nota_nic){
		$this->nota_nic = $nota_nic;
	}
	...
	/**
	 * Devuelve el valor del campo cuenta_movi
	 * @return string
	 */
	public function getCuentaMovi(){
		return $this->cuenta_movi;
	}

	/**
	 * Devuelve el valor del campo nic
	 * @return integer
	 */
	...
	/**
	 * Devuelve el valor del campo nota_nic
	 * @return string
	 */
	public function getNotaNic(){
