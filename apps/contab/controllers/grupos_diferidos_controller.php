...
/**
 * Grupos_DiferidosController
 *
 * Controlador de los grupos de diferidos
 *
 */
class Grupos_DiferidosController extends HyperFormController {

	static protected $_config = array(
		'model' => 'GruposDiferidos',
		'plural' => 'grupos de diferidos',
		'single' => 'grupo de diferidos',
		'genre' => 'M',
		'icon' => 'product.png',
		...
		'fields' => array(
			...
			'cta_dev_ventas' => array(
				'single' => 'Cuenta Amortización Débito',
				'type' => 'cuenta',
				'genre' => 'F',
				'notBrowse' => true,
				'notSearch' => true,
			...
			'cta_dev_compras' => array(
				'single' => 'Cuenta Amortización Crédito',
				'type' => 'cuenta',
				'genre' => 'F',
				'notBrowse' => true,
				'notSearch' => true,
