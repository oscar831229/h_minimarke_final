...
/**
 * Interface_Siigo_ProController
 */
class Interface_Siigo_ProController extends ApplicationController
{
	...
	public function indexAction()
	{
		...
		$comprobProveedores1 = Settings::get('comprob_ventas');
		if ($comprobProveedores1) {
			Tag::displayTo('fecha', (string) $this->Movi->maximum(
				array('fecha', 'conditions' => "comprob = '$comprobProveedores1'")
			));
		}
	...
	public function generarAction()
	{
		...
		$comprobProveedores1 = Settings::get('comprob_proveedores1');
		if (!$comprobProveedores1) {
			return array(
				'status' => 'FAILED',
				'message' => 'El comprobante de proveedores no está configurado'
			);
		}

		$comprobProveedores2 = Settings::get('comprob_proveedores2');
		if (!$comprobProveedores2) {
			return array(
				'status' => 'FAILED',
		...
		if ($tipo == 'P') {
			return $this->_processProveedores($fecha, $comprobProveedores1, $comprobProveedores2);
		} else {
			return $this->_processTerceros($fecha, $comprobProveedores1, $comprobProveedores2);
		}
	}
	...
	protected function _processTerceros($fecha, $comprobVentas, $comprobIngresos)
	{
		...
		$fileName = 'temp/PV' . $fechaFile . '.txt';
	...
	protected function _processProveedores($fecha, $comprobVentas, $comprobIngresos)
	{
