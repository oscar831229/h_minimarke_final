...
/**
 * Reabrir_CuentasController
 *
 * Reabre el cierre de cuentas de iva y retención
 *
 */
class Reabrir_CuentasController extends ApplicationController
{
	...
	public function indexAction(){
		...
		$this->setParamToView('message', 'Indique el tipo de cuenta y la fecha del nuevo cierre');
	...
	public function reabrirAction(){
		...
		try {
			...
			$empresa1 = $this->Empresa1->findFirst();
			if($empresa1==false){
				$transaction->rollback('No existe el empresa1');
			}
