...
class SocioshMigration_105 extends ActiveRecordMigration {

	public function up(){
		$this->morphTable('sociosh', array(
			'columns' => array(
				...
				new DbColumn('cambio_contrato', array(
					'type' => DbColumn::TYPE_CHAR,
					'size' => 1,
					'after' => 'nota_historia_id'
				)),
				new DbColumn('valor_cambio_contrato', array(
					'type' => DbColumn::TYPE_DECIMAL,
					'size' => 10,
					'scale' => 2,
					'after' => 'cambio_contrato'
				))
			),
			'indexes' => array(
				...
				new DbIndex('tipo_documentos_id', array(
					'tipo_documentos_id'
				)),
				...
				new DbIndex('tipo_contrato_id', array(
					'tipo_contrato_id'
				)),
