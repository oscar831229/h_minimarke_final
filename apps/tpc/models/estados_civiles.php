...
class EstadosCiviles extends RcsRecord {
	...
	public function beforeDelete(){
	    ...
	    foreach ($listModels as $model  => $label){
    	    ...
    	    $exists = $modeloObj->exists('estados_civiles_id='.$this->id);
    	    if($exists == true){
    	        $this->appendMessage(new ActiveRecordMessage('El estado civil esta siendo usado en '.$label));
    	        $status = false;
    	    }    
	    }
